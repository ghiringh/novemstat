angular.module('novemstat').service('AuthService', function(store) {
...
angular.module('novemstat').controller('LoginCtrl', function(apiUrl, AuthService, $http, $ionicHistory, $ionicLoading, $scope, $state) {
  var loginCtrl = this;
...
angular.module('novemstat').controller('LogoutCtrl', function(AuthService, $state) {
  var logoutCtrl = this;
...
angular.module('novemstat').factory('AuthInterceptor', function(AuthService) {
  return {
